...
\begin{nrcanFrame}
  ...
  \begin{itemize}
  \item \textit{\href{https://docs.aws.amazon.com/lambda/latest/dg/best-practices.html}{Best practices for working with AWS Lambda functions}}
  ...
  \item \textit{\href{https://www.intentsg.com/aws-lambda-serverless-coding-best-practices/}{AWS Lambda Serverless Coding Best Practices}}
  \item
